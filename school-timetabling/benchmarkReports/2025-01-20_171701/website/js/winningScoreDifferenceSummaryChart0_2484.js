...
var chart_winningScoreDifferenceSummaryChart0_2484 = new Chart(document.getElementById('chart_winningScoreDifferenceSummaryChart0_2484'), {
    type: 'bar',
    data: {
        labels: [
            'comp01'
...
window.addEventListener('beforeprint', () => {
  chart_winningScoreDifferenceSummaryChart0_2484.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_winningScoreDifferenceSummaryChart0_2484.resize();
});