...
var chart_scoreCalculationSpeedSummaryChart_116cf = new Chart(document.getElementById('chart_scoreCalculationSpeedSummaryChart_116cf'), {
    type: 'line',
    data: {
        datasets: [
            {
...
window.addEventListener('beforeprint', () => {
  chart_scoreCalculationSpeedSummaryChart_116cf.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_scoreCalculationSpeedSummaryChart_116cf.resize();
});
