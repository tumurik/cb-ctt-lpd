...
var chart_winningScoreDifferenceSummaryChart1_ab295 = new Chart(document.getElementById('chart_winningScoreDifferenceSummaryChart1_ab295'), {
    type: 'bar',
    data: {
        labels: [
            'comp01'
...
window.addEventListener('beforeprint', () => {
  chart_winningScoreDifferenceSummaryChart1_ab295.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_winningScoreDifferenceSummaryChart1_ab295.resize();
});