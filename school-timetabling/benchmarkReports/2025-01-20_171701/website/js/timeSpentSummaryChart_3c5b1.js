...
var chart_timeSpentSummaryChart_3c5b1 = new Chart(document.getElementById('chart_timeSpentSummaryChart_3c5b1'), {
    type: 'bar',
    data: {
        labels: [
            'comp01'
...
window.addEventListener('beforeprint', () => {
  chart_timeSpentSummaryChart_3c5b1.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_timeSpentSummaryChart_3c5b1.resize();
});