...
var chart_worstScoreDifferencePercentageSummaryChart0_191e = new Chart(document.getElementById('chart_worstScoreDifferencePercentageSummaryChart0_191e'), {
    type: 'bar',
    data: {
        labels: [
            'comp01'
...
window.addEventListener('beforeprint', () => {
  chart_worstScoreDifferencePercentageSummaryChart0_191e.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_worstScoreDifferencePercentageSummaryChart0_191e.resize();
});